...
using Shadow_Queue.Server.Models;
using Debug = CitizenFX.Core.Debug;

namespace Shadow_Queue.Server
{
    public class Server : BaseScript
    {
        ...
        public Server()
        {
            try
            {
                _configPath = API.GetConvar("shadow_queue_config", "queueSettings.yml");
                ...
                HandleEvent<Player>("Young:queue:playerActive", OnPlayerActive);
        ...
        private void OnRconCommand(string command, List<object> objargs)
        {
            ...
            switch (args[0].ToLowerInvariant())
            {
                ...
                case "move":
                    ...
                    break;
                case "help":
                    Log("Shadow - Queue: Help" + Environment.NewLine +
